...
public class Constants {
    public Constants(){}
    // Root page
    public static String WEBAPP_URL = "https://www.tiktok.com/";
    public static String WEBAPP_HOST = "tiktok.com"; // used for checking Intent-URLs
    ...
    public static String USER_AGENT = "Mozilla/5.0 (compatible; MSIE 10.0; Windows Phone 8.0; Trident/6.0; IEMobile/10.0; ARM; Touch; NOKIA; Lumia 920) UCBrowser/10.1.0.563 Mobile";
