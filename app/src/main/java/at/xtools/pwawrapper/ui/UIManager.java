...
public class UIManager {
    ...
    public void changeRecentAppsIcon() {
        // Old version supported Android Lollipop
        TypedValue typedValue = new TypedValue();
        Resources.Theme theme = activity.getTheme();
        theme.resolveAttribute(R.attr.colorPrimary, typedValue, true);
        int color = typedValue.data;

        // Old version used ActivityManager.TaskDescription(String, Bitmap, int);
        ActivityManager.TaskDescription description = new ActivityManager.TaskDescription.Builder()
                .setLabel(activity.getResources().getString(R.string.app_name))
                .setIcon(R.drawable.ic_appbar)
