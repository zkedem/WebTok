...
// import android.net.NetworkInfo; is deprecated
...
public class WebViewHelper {
    ...
    private boolean isNetworkAvailable() {
        ...
        // NetworkInfo networkInfo = manager.getActiveNetworkInfo(); is deprecated
        NetworkCapabilities capabilities = manager.getNetworkCapabilities(manager.getActiveNetwork());

        boolean isAvailable = false;
        // if (networkInfo != null && networkInfo.isConnected()) { is deprecated
    ...
    public void setupWebView() {
        ...
        // webSettings.setAppCachePath(activity.getApplicationContext().getCacheDir().getAbsolutePath()); is deprecated
        webSettings.setCacheMode(WebSettings.LOAD_DEFAULT); // Replaces webSettings.setAppCacheEnabled(true);
        ...
        webView.setWebViewClient(new WebViewClient() {
            ...
            public void onReceivedError(WebView view, WebResourceRequest request, WebResourceError error) {
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                    ...
                    if (Objects.requireNonNull(view.getUrl()).equals(url)) {
